# 🕷️ Web Crawler — Take-Home Assignment v1.2
...
This assignment is intentionally open-ended. We want to see how _you_
...
_deliberate decision not to add infrastructure_ — well argued — is just as
...
1. **Your complete solution**, pushed to the private repository we created
   for you. Commit history is part of the submission and we will review it.
...
3. **An AI work log** (`AI_WORKLOG.md` in the repo root):
   - The **IDE / platform / coding agent(s)** you used
   - The **model(s)** used at each stage (planning, scaffolding,
     implementation, review/refactor) — and _why_ you chose them, if the
     choice was deliberate
   - If you worked without AI assistance, state that.

4. **Full transcript(s) of your AI conversations**, committed to the repo
   (e.g., under `ai-transcripts/`), in whatever format your tool exports —
   markdown, JSON, or plain text. If a tool cannot export, a copy-paste or
   screenshots are acceptable.

> How you direct and verify an AI agent is part of what we evaluate — the
> prompts you write, what you accept, what you reject, and what you rework
> are engineering decisions like any other. Treat the transcript as a
...
- **Code quality** — readability, cohesion, and the right _amount_ of code
...
> Build something you'd be proud to put in front of a code review —
